...
set top_dir [file normalize $repo_path/Top/$group/$proj_name]
lassign [GetRepoVersions $top_dir $repo_path $ext_path] \
...
set describe [GetHogDescribe $top_dir $repo_path]
...
if {$xml_hash != ""} {
  ...
  CopyIPbusXMLs ./Top/$group/$proj_name/ $repo_path $xml_dst [HexVersionToString $xml_ver] $xml_hash
  set use_ipbus 1
} else {
  set use_ipbus 0
}
