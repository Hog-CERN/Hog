...
lassign [Execute curl {-s --request GET --header "PRIVATE-TOKEN: ${push_token}" $curl_url}] ret msg
if {$ret != 0} {
  ...
  foreach Child $ChildList {
    ...
    lassign [Execute curl {-s --location --header "PRIVATE-TOKEN: ${push_token}" "${api}/projects/${proj_id}/jobs/${child_job_id}/artifacts/" -o output_${child_job_id}.zip}] ret msg
    if {$ret != 0} {
