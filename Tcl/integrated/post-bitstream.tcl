...
if [file exists $fw_file] {
    ...
    set dst_dir [file normalize "$bin_dir/$name\-git-$describe"]
    set dst_bit [file normalize "$dst_dir/$name\-git-$describe.bit"]
    set dst_bin [file normalize "$dst_dir/$name\-git-$describe.bin"]
    set dst_ltx [file normalize "$dst_dir/$name\-git-$describe.ltx"]    
